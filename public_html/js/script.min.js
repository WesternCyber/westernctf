...
function masonryFlyIn() {
    var e = $(".masonryFlyIn .masonry-item"), t = 0;
    e.each(function () {
        var e = $(this);
        setTimeout(function () {
            e.addClass("fadeIn")
...
function updateFloatingFilters() {
    for (var e = mr_floatingProjectSections.length; e--;) {
        ...
        t.elemTop < mr_scrollTop && "undefined" == typeof window.mr_variant ? (t.filters.css({
            ...
            top: "16px",
            bottom: "auto"
        }), mr_navScrolled && t.filters.css({transform: "translate3d(-50%,48px,0)"}), mr_scrollTop > t.elemBottom - 70 && (t.filters.css({
            position: "absolute",
            bottom: "16px",
            top: "auto"
        }), t.filters.css({transform: "translate3d(-50%,0,0)"}))) : t.filters.css({
            position: "absolute",
...
function prepareSignup(e) {
    var t = jQuery("<form />"), a = e.contents().find("form").attr("action");
    return /list-manage\.com/.test(a) && (a = a.replace("/post?", "/post-json?") + "&c=?", "//" == a.substr(0, 2) && (a = "http:" + a)), /createsend\.com/.test(a) && (a += "?callback=?"), t.attr("action", a), e.contents().find("input, select, textarea").not('input[type="submit"]').each(function () {
        $(this).clone().appendTo(t)
    }), t
}
var mr_firstSectionHeight, mr_nav, mr_navOuterHeight, mr_navScrolled = !1, mr_navFixed = !1, mr_outOfSight = !1, mr_floatingProjectSections, mr_scrollTop = 0;
$(document).ready(function () {
    ...
    if ($(".inner-link").each(function () {
            ...
            var e = $(this).offset(), t = e.left + $(this).outerWidth(!0);
            if (t > $(window).width() && !$(this).hasClass("mega-menu"))$(this).addClass("make-right"); else if (t > $(window).width() && $(this).hasClass("mega-menu")) {
                var a = $(window).width() - e.left, i = $(this).outerWidth(!0) - a;
            ...
            $(this).closest(".filters").find("li").removeClass("active"), $(this).addClass("active"), $(this).closest(".projects").find(".project").each(function () {
                ...
                -1 == t.indexOf(e) ? $(this).addClass("inactive") : $(this).removeClass("inactive")
            }), "all" == e && $(this).closest(".projects").find(".project").removeClass("inactive")
        }), $(".tweets-feed").each(function (e) {
            $(this).attr("id", "tweets-" + e)
        }).each(function (e) {
            function t(t) {
                for (var a = t.length, i = 0, s = document.getElementById("tweets-" + e), o = '<ul class="slides">'; a > i;)o += "<li>" + t[i] + "</li>", i++;
                return o += "</ul>", s.innerHTML = o, o
            }

            twitterFetcher.fetch($("#tweets-" + e).attr("data-widget-id"), "", 5, !0, !0, !0, "", !1, t)
        }), $(".instafeed").length && (jQuery.fn.spectragram.accessData = {
            accessToken: "1406933036.fedaafa.feec3d50f5194ce5b705a1f11a107e0b",
            clientID: "fedaafacf224447e8aef74872d3820a1"
        }, $(".instafeed").each(function () {
            var e = $(this).attr("data-user-name") + "_";
            $(this).children("ul").spectragram("getUserFeed", {query: e, max: 12})
        })), $(".flickr-feed").length && $(".flickr-feed").each(function () {
            var e = $(this).attr("data-user-id"), t = $(this).attr("data-album-id");
            $(this).flickrPhotoStream({id: e, setId: t, container: '<li class="masonry-item" />'})
            ...
            animation: "slide",
            directionNav: !1
        }), $(".slider-arrow-controls").flexslider({controlNav: !1}), $(".slider-thumb-controls .slides li").each(function () {
            ...
            var e = $(this).attr("data-provider"), t = $(this).attr("data-video-id"), a = $(this).attr("data-autoplay"), i = "";
            "vimeo" == e ? (i = "http://player.vimeo.com/video/" + t + "?badge=0&title=0&byline=0&title=0&autoplay=" + a, $(this).attr("data-src", i)) : "youtube" == e ? (i = "https://www.youtube.com/embed/" + t + "?showinfo=0&autplay=" + a, $(this).attr("data-src", i)) : console.log("Only Vimeo and Youtube videos are supported at this time")
        }), $(".foundry_modal").length) {
        $('<div class="modal-screen">').appendTo("body")
    }
    if ($(".foundry_modal").click(function () {
            $(this).addClass("modal-acknowledged")
        }), $(".modal-container").each(function (e) {
            if ($(this).find("iframe[src]").length) {
                $(this).find(".foundry_modal").addClass("iframe-modal");
                var t = $(this).find("iframe");
                t.attr("src", "")
            }
            $(this).find(".btn-modal").attr("modal-link", e), $(this).find(".foundry_modal").clone().appendTo("body").attr("modal-link", e).wrapInner('<div class="modal-data" style="height: 100%; overflow-y: scroll;">').prepend($('<i class="ti-close close-modal">'))
        }), $(".btn-modal").click(function () {
            var e = $("section").closest("body").find('.foundry_modal[modal-link="' + $(this).attr("modal-link") + '"]');
            if ($(".modal-screen").toggleClass("reveal-modal"), e.find("iframe").length) {
            ...
            var e = $(this), t = e.attr("data-time-delay");
            ...
            var e = $(this), t = e.attr("data-hide-after");
            ...
            e.toggleClass("reveal-modal"), "undefined" != typeof e.attr("data-cookie") && mr_cookies.setItem(e.attr("data-cookie"), "true", 1 / 0), e.find("iframe").length && e.find("iframe").attr("src", ""), $(".modal-screen").toggleClass("reveal-modal")
        }), $(".modal-screen").click(function () {
            $(".foundry_modal.reveal-modal").find("iframe").length && $(".foundry_modal.reveal-modal").find("iframe").attr("src", ""), $(".foundry_modal.reveal-modal").toggleClass("reveal-modal"), $(this).toggleClass("reveal-modal")
        }), $(document).keyup(function (e) {
            27 == e.keyCode && ($(".foundry_modal").find("iframe").length && $(".foundry_modal").find("iframe").attr("src", ""), $(".foundry_modal").removeClass("reveal-modal"), $(".modal-screen").removeClass("reveal-modal"))
            ...
            return "undefined" != typeof e.attr("data-cookie") && mr_cookies.setItem(e.attr("data-cookie"), "true", 1 / 0), $(this).closest(".modal-strip").removeClass("reveal-modal"), !1
            ...
            var e = $(this).hasClass("checked"), t = $(this).find("input").attr("name");
            ...
            var t = $(this).attr("data-video-id"), a = $(this).attr("data-start-at");
            ...
            var e = $(this).closest("section"), t = e.find(".player");
                ...
                if (console.log("Using nob type mailer engine"), "undefined" != typeof p && p !== !1 && c.html(p), s = $(m).find('[name="message"]').val(), o = "nob" == g ? $(m).find(".signup-email-field").val() : $(m).find('[name="email"]').val(), n = "nob" == g ? $(m).find(".signup-name-field").val() : $(m).find('[name="name"]').val(), "nob" == g && (r = $(m).find("input.signup-first-name-field").length ? $(m).find("input.signup-first-name-field").val() : $(m).find(".signup-name-field").val(), l = $(m).find(".signup-last-name-field").val()), 1 !== e(m)) {
                    ...
                    try {
                        ...
                        $.ajax({
                            ...
                            success: function (e) {
                                console.log(e), "success" != e.result ? (c.attr("original-error", c.text()), c.html(e.message).fadeIn(1e3), f.fadeOut(1e3), u.html(u.attr("data-text")).removeAttr("disabled")) : (u.html(u.attr("data-text")).removeAttr("disabled"), d = m.attr("success-redirect"), "undefined" != typeof d && d !== !1 && "" !== d && (window.location = d), m.find('input[type="text"]').val(""), m.find("textarea").val(""), f.fadeIn(1e3), c.fadeOut(1e3), setTimeout(function () {
                                    f.fadeOut(500)
                                }, 5e3))
                            },
                            error: function (e) {
                                console.log("Nob mailer error:"), console.log(e), c.attr("original-error", c.text()), c.html(e).fadeIn(1e3), f.fadeOut(1e3), u.html(u.attr("data-text")).removeAttr("disabled")
                            }
                        })
                    } catch (y) {
                        console.log(y), c.attr("original-error", c.text()), c.html(y.message).fadeIn(1e3), f.fadeOut(1e3), setTimeout(function () {
                            c.fadeOut(500)
                        }, 5e3), u.html(u.attr("data-text")).removeAttr("disabled")
                    }
                } else c.fadeIn(1e3), setTimeout(function () {
                    c.fadeOut(500)
                }, 5e3)
            } else if (i.length && "undefined" != typeof i.attr("srcdoc") && "" !== i.attr("srcdoc"))if (console.log("Mail list form signup detected."), "undefined" != typeof p && p !== !1 && c.html(p), o = $(m).find(".signup-email-field").val(), n = $(m).find(".signup-name-field").val(), r = $(m).find("input.signup-first-name-field").length ? $(m).find("input.signup-first-name-field").val() : $(m).find(".signup-name-field").val(), l = $(m).find(".signup-last-name-field").val(), 1 !== e(m)) {
                a = prepareSignup(i), a.find("#mce-EMAIL, #fieldEmail").val(o), a.find("#mce-LNAME, #fieldLastName").val(l), a.find("#mce-FNAME, #fieldFirstName").val(r), a.find("#mce-NAME, #fieldName").val(n), m.removeClass("attempted-submit"), c.fadeOut(200), u.html(jQuery("<div />").addClass("form-loading")).attr("disabled", "disabled");
                try {
                    $.ajax({
                        url: a.attr("action"),
                        crossDomain: !0,
                        ...
                        contentType: "application/json; charset=utf-8",
                        success: function (e) {
                            "success" != e.result && 200 != e.Status ? (c.attr("original-error", c.text()), c.html(e.msg).fadeIn(1e3), f.fadeOut(1e3), u.html(u.attr("data-text")).removeAttr("disabled")) : (u.html(u.attr("data-text")).removeAttr("disabled"), d = m.attr("success-redirect"), "undefined" != typeof d && d !== !1 && "" !== d && (window.location = d), m.find('input[type="text"]').val(""), m.find("textarea").val(""), f.fadeIn(1e3), c.fadeOut(1e3), setTimeout(function () {
                                f.fadeOut(500)
                            }, 5e3))
                        }
                    })
                } catch (y) {
                    c.attr("original-error", c.text()), c.html(y.message).fadeIn(1e3), f.fadeOut(1e3), setTimeout(function () {
                        c.fadeOut(500)
                    }, 5e3), u.html(u.attr("data-text")).removeAttr("disabled")
                }
            } else c.fadeIn(1e3), setTimeout(function () {
                c.fadeOut(500)
            }, 5e3); else console.log("Send email form detected."), "undefined" != typeof p && p !== !1 && c.text(p), h = e(m), 1 === h ? (c.fadeIn(200), setTimeout(function () {
                c.fadeOut(500)
            }, 3e3)) : (m.removeClass("attempted-submit"), c.fadeOut(200), u.html(jQuery("<div />").addClass("form-loading")).attr("disabled", "disabled"), jQuery.ajax({
                type: "POST",
                url: "mail/mail.php",
                data: m.serialize() + "&url=" + window.location.href,
                success: function (e) {
                    u.html(u.attr("data-text")).removeAttr("disabled"), $.isNumeric(e) ? parseInt(e) > 0 && (d = m.attr("success-redirect"), "undefined" != typeof d && d !== !1 && "" !== d && (window.location = d), m.find('input[type="text"]').val(""), m.find("textarea").val(""), m.find(".form-success").fadeIn(1e3), c.fadeOut(1e3), setTimeout(function () {
                        f.fadeOut(500)
                    }, 5e3)) : (c.attr("original-error", c.text()), c.text(e).fadeIn(1e3), f.fadeOut(1e3))
                },
                error: function (e, t, a) {
                    c.attr("original-error", c.text()), c.text(a).fadeIn(1e3), f.fadeOut(1e3), u.html(u.attr("data-text")).removeAttr("disabled")
                }
            }));
            return !1
    ...
    if (document.querySelector("[data-maps-api-key]") && !document.querySelector(".gMapsAPI") && $("[data-maps-api-key]").length) {
        var i = document.createElement("script"), s = $("[data-maps-api-key]:first").attr("data-maps-api-key");
        i.type = "text/javascript", i.src = "https://maps.googleapis.com/maps/api/js?key=" + s + "&callback=initializeMaps", i.className = "gMapsAPI", document.body.appendChild(i)
    }
}), $(window).load(function () {
    "use strict";
    if ($(".masonry").length) {
        var e = document.querySelector(".masonry"), t = new Masonry(e, {itemSelector: ".masonry-item"});
    ...
    "undefined" != typeof google && "undefined" != typeof google.maps && $(".map-canvas[data-maps-api-key]").each(function () {
        var e, t, a, i = this, s = "undefined" != typeof $(this).attr("data-map-style") ? $(this).attr("data-map-style") : !1, o = JSON.parse(s) || [{
        ...
        void 0 != $(this).attr("data-marker-title") && "" != $(this).attr("data-marker-title") && (m = $(this).attr("data-marker-title")), void 0 != f && "" != f[0] ? c.geocode({address: f[0].replace("[nomarker]", "")}, function (e, t) {
            if (t == google.maps.GeocoderStatus.OK) {
                var s = new google.maps.Map(i, h);
                s.setCenter(e[0].geometry.location), f.forEach(function (e) {
                    var t;
                    if (a = {
                            url: void 0 == window.mr_variant ? "img/mapmarker.png" : "../img/mapmarker.png",
                            size: new google.maps.Size(50, 50),
                            scaledSize: new google.maps.Size(50, 50)
                        }, /(\-?\d+(\.\d+)?),\s*(\-?\d+(\.\d+)?)/.test(e))var i = e.split(","), o = new google.maps.Marker({
                        position: {
                            lat: 1 * i[0],
                            lng: 1 * i[1]
                        }, map: s, icon: a, title: m, optimised: !1
                    }); else e.indexOf("[nomarker]") < 0 && (t = new google.maps.Geocoder, t.geocode({address: e.replace("[nomarker]", "")}, function (e, t) {
                        t == google.maps.GeocoderStatus.OK && (o = new google.maps.Marker({
                            map: s,
                            icon: a,
                            title: m,
...
var mr_cookies = {
    getItem: function (e) {
        ...
        return document.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + n + (s ? "; domain=" + s : "") + (i ? "; path=" + i : "") + (o ? "; secure" : ""), !0
