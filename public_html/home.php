            ...
            <nav>
                <div class="nav-bar">
                    <div class="module left">
                        <a href="index.html">
                            <img class="logo logo-dark" alt="WSCS" src="img/LOGO-head.jpg" /><img class="logo logo-dark" alt="WSCS" src="img/LOGO-txt.jpg" />
                        </a>
                    ...
                    <div class="module-group right"> 
                        <div class="module left">
                            <ul class="menu">
                                ...
                                <li>
                                <a href="Write-ups.html">Write-Ups</a>
                                </li>
        ...
        <div class="main-container">
            ...
            <section class="pt120 pb120 image-bg overlay">
                <div class="background-image-holder">
                    <img alt="Background" class="background-image" src="img/BANNER.jpg" />
                </div>
                <div class="container">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <form class="halves form-newsletter" data-form-type="nob" data-success="Thanks for your submission, we will be in touch shortly." data-error="Please fill all fields correctly.">
                                <input class="mb8 validate-required validate-email signup-email-field" type="text" placeholder="Email Address" name="email" />
